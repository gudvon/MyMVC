...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 04 2016 г., 15:15
...
(4, '<p>Take one look at the new iPhoto app and you&rsquo;ll know exactly what he means. Completing the iPhoto trinity on the iPad kicked off by &hellip;</p>', '2016-03-29 03:23:59', 21, 1),
(5, '<p>It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards the viewer.</p>', '2016-03-29 03:24:05', 21, 1),
(6, '<p>Gregor then turned to look out the window at the dull weather.</p>\r\n<p>Drops of rain could be heard hitting the pane, which made him feel quite sad.</p>', '2016-03-29 03:24:12', 21, 1),
(8, '<p>My name is Serge and I am Web Designer and Developer. I love all #design and #webdesign styles. Also I create a #Responsive #WordPress themes and #HTML5 #CSS3.</p>', '2016-03-29 03:31:26', 18, 1),
(9, '<p>Oh yes, this car is awesome and even better in real!</p>', '2016-03-29 03:31:32', 18, 1),
(10, '<p>A collection of textile samples lay spread out on the table &ndash; Samsa was a travelling salesman &ndash; and above it there hung a picture that he had recently cut out of an illustrated magazine and housed in a nice, gilded frame.</p>', '2016-03-29 03:31:39', 18, 1),
(11, '<p>test</p>', '2016-03-29 03:31:44', 18, 1),
(12, '<p>A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart.</p>', '2016-03-29 03:33:50', 17, 1),
(13, '<p><span class="fn">Tom Rhodes</span>: Vestibulum id ligula porta felis euismod semper. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum.</p>', '2016-03-29 11:30:52', 17, 2),
(14, '<p><span class="fn">Tom Rhodes</span>: Vestibulum id ligula porta felis euismod semper. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cras mattis consectetur purus sit amet fermentum.</p>', '2016-03-29 11:32:19', 17, 2),
(19, '<p>Nice&nbsp;battery!</p>', '2016-04-03 17:45:17', 11, 2),
(20, '<p>Fuuuunny</p>', '2016-04-03 17:45:27', 12, 2);
...
(1, 'admin', 'gudvon@gmail.com', 'admin', '48fb7b7996311a895502e77e9db97e1f', 1, 'Administrator', 'Kirill', '0934356043', 'vk.com/is4ibertay', 'facebook.com/id15275601', NULL, NULL, NULL),
...
(3, 'user2', 'user2@mail', 'user', '0073c7c57f5bb6a7e8b9610f7c541a35', 1, 'Griwyn', 'Артём Адамович', '0987654321', 'id562115673', 'id2522stw3535', NULL, NULL, NULL),
(4, 'dasha', 'darja-b@ukr.net', 'user', 'f45fb5f812f1113c2f9089efd7496203', 1, '', '', '', '', '', NULL, NULL, NULL),
(5, 'user3', 'user3@mail', 'user', '4d54276ea258cbe84653d4d55d778067', 1, 'Shaktir', '???? ?????????', '02543737543', '', '', NULL, '/webroot/img/avatars/5.jpg', 'Female'),
(22, 'dashka', 'darja-b@ukr.net', 'user', 'f45fb5f812f1113c2f9089efd7496203', 1, 'dasha', 'dasha2', '123', '123', '123', NULL, '/webroot/img/avatars/22.jpg', NULL);
